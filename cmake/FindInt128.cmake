...
MACRO(FIND_INT128_TYPES)
  ...
  if(INT128_FOUND)
    ...
    message(FATAL_ERROR "Compiler/platform support for 128 bit integers not found.")
  endif()
  ...
  if(UINT128_FOUND)
    ...
    message(FATAL_ERROR "Compiler/platform support for unsigned 128 bit integers not found.")
  endif()
