...
//FIXME: unofficial names, not actually used in the bytecode stream
#define BIND_TYPE_THREADED_POINTER                              100
#define BIND_TYPE_THREADED_POINTER_AUTH                         101
#define BIND_TYPE_THREADED_REBASE                               102
#define BIND_TYPE_THREADED_REBASE_AUTH                          103
...
//opcodes used for shared region info (LC_SEGMENT_SPLIT_INFO)

// version 1:
/// ( <opcode> (delta-uleb128)+ <zero> )+ <zero>
#define DYLD_CACHE_ADJ_V1_POINTER_32             0x01 // 32-bit pointer
#define DYLD_CACHE_ADJ_V1_POINTER_64             0x02 // 64-bit pointer
#define DYLD_CACHE_ADJ_V1_ADRP                 0x03 // arm64 ADRP
#define DYLD_CACHE_ADJ_V1_PPC_HI16               0x03 // ppc hi16
#define DYLD_CACHE_ADJ_V1_IMP32                          0x04 //32-bit offset to IMPORT
#define DYLD_CACHE_ADJ_V1_ARM_THUMB_MOVW 0x05 //thumb2 movw
#define DYLD_CACHE_ADJ_V1_ARM_MOVW               0x06 //ARM movw
#define DYLD_CACHE_ADJ_V1_ARM_THUMB_MOVT 0x10 // thru 0x1F thumb2 movt low high 4 bits=0..15
#define DYLD_CACHE_ADJ_V1_ARM_MOVT                       0x20 // thru 0x2F arm movt low high 4 bits=0..15
