...
//----------------------------------------------------------------------
uint32 st9_t::refresh_idpflags(void)
{
  ...
  switch ( msgid )
  {
    ...
    case processor_t::ev_is_switch:
      {
        ...
        const insn_t *insn = va_arg(va, const insn_t *);
        return st9_is_switch(si, *insn) ? 1 : 0;
      }
    ...
    case processor_t::ev_is_insn_table_jump:
      ...
      // returns: 0-yes, <0-no
      {
        ...
        // this is an indirect jump or call instruction
        // only allow indirect registers
