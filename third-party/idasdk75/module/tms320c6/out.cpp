...
//
  ...
  if ( (insn.cflags & aux_para) == 0 )
  {
    ...
    nodeidx_t ndx = pm.tnode.altval_ea(ea);
    switch ( ndx )
    {
      case 1:
        gen_printf(DEFAULT_INDENT, COLSTR("; BRANCH OCCURS", SCOLOR_AUTOCMT));
        break;
      case 2:
        gen_printf(DEFAULT_INDENT, COLSTR("; CALL OCCURS", SCOLOR_AUTOCMT));
        break;
      default:
        if ( ndx != 0 )
        {
